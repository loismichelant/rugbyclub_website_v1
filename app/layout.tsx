      ...
      <body className="bg-[#f8fafc] text-[#000049] antialiased flex flex-col min-h-screen">
        ...
        <footer className="bg-[#000049] text-white/80 pt-16 pb-8 border-t-0">
          <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-12">
            ...
            {/* Présentation rapide et logo inversé */}
            ...
            {/* Coordonnées et adresse du terrain d'entraînement */}
              ...
              <ul className="flex flex-col gap-3 text-sm font-light text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <Link 
                    ...
                    className="hover:text-[#f368f1] transition-colors duration-200 underline underline-offset-4 decoration-white/20 hover:decoration-[#f368f1]"
                  >
                    Parc Henri-Julien, Montréal, QC
                  </Link>
                </li>
            ...
            <div className="lg:col-span-3">
              ...
              <div className="flex gap-4">
                <a 
                  href="https://www.facebook.com/EcoleRugbyGauloisMTL/?locale=fr_CA" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#f368f1] text-white hover:scale-110 transition-all duration-200" 
                  aria-label="Facebook"
                >
                ...
                <a 
                  href="https://www.instagram.com/gaulois_de_montreal/" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#f368f1] text-white hover:scale-110 transition-all duration-200" 
