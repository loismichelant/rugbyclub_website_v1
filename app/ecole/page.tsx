...
import ProchainTournoi from "../components/ProchainTournoi"; 
...
export default function EcolePage() {
  return (
    <main className="min-h-screen bg-[#f8fafc] text-[#000049] overflow-x-hidden">
      ...
      {/* Calendrier de la semaine et prochain tournoi */}
      <section className="pt-20 pb-10 px-6 max-w-6xl mx-auto">
        ...
        {/* Intégration du composant dynamique de compte à rebours */}
        <div className="mt-10">
          <ProchainTournoi />
        </div>
      </section>

      {/* Grille des catégories d'âge */}
      ...
      {/* Frise chronologique (Timeline) de la saison annuelle */}
      ...
      {/* Zone finale d'appel à l'action */}
