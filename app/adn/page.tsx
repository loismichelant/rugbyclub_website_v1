...
/**
 * Page ADN & Valeurs (Client Component)
 * Ce composant présente la philosophie, la charte éthique et l'équipe technique du club.
 * Il utilise l'état local (useState) pour gérer l'affichage dynamique des chartes (onglets).
 */
export default function AdnPage() {
  // ÉTAT LOCAL : Permet de basculer dynamiquement entre les trois profils de chartes (Joueur, Parents, Éducateur)
  const [activeTab, setActiveTab] = useState<"joueur" | "parents" | "educateur">("joueur");

  // DONNÉES DE CONFIGURATION : Liste du personnel d'encadrement technique - TEMPORAIRE
  const coaches = [
  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] text-[#000049]">
      ...
      {/* HEADER DE LA PAGE (Hero section contextuelle) */}
      <section className="relative bg-[#000049] text-white py-20 px-6 text-center overflow-hidden">
        {/* Overlay en dégradé linéaire appliqué via les utilitaires de couleur Tailwind pour optimiser le contraste du texte */}
      ...
      {/* SECTION 1 : LE MANIFESTE DES 5 VALEURS */}
      <section className="py-20 px-6 max-w-6xl mx-auto">
        ...
        {/* Grille adaptative : Passe d'une colonne (mobile) à 3 (tablettes) puis 5 (écrans larges) */}
      ...
      {/* SECTION 2 : PRÉSENTATION DES ENTRAÎNEURS */}
      <section className="bg-white py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            {/* Texte marketing de gauche */}
            ...
            {/* Grille de rendu des cartes d'entraîneurs (2/3 de l'espace sur desktop) */}
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-6">
              {coaches.map((coach, i) => (
                <div key={i} className="bg-[#f8fafc] rounded-2xl overflow-hidden border border-[#000049]/5 hover:border-[#f368f1]/30 transition-all group">
                  {/* Zone d'accueil pour la future intégration des photos des entraîneurs */}
      ...
      {/* SECTION 3 : LES CHARTES INTERACTIVES (Système d'onglets dynamiques) */}
      <section className="py-20 px-6 max-w-4xl mx-auto">
        ...
        {/* Contrôles de navigation des onglets (Tab bar) */}
        ...
        {/* ZONE DE RENDU CONDITIONNEL DU CONTENU DE L'ONGLET SÉLECTIONNÉ */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div>
                  ...
                  <ul className="text-xs text-[#000049]/80 space-y-2 list-disc pl-4 font-light">
                    ...
                    <li>Le respect de tes éducateurs, dirigeants, adversaires et de tout l’environnement (notamment en match).</li>
                ...
                <div className="md:col-span-2 lg:col-span-1">
                  ...
                  <ul className="text-xs text-[#000049]/80 space-y-2 list-disc pl-4 font-light">
                    ...
                    <li>Participer aux petites tâches matérielles quand on te le demande ou spontanément (rangement du matériel, propreté des lieux, etc.).</li>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <ul className="text-xs text-[#000049]/80 space-y-3 list-disc pl-4 font-light">
                  ...
                  <li><strong>Implication :</strong> Je m&apos;implique au maximum dans la vie du club (accompagnement, goûters, jamborees...).</li>
                </ul>
                <ul className="text-xs text-[#000049]/80 space-y-3 list-disc pl-4 font-light">
                  <li><strong>Ponctualité :</strong> Je fais en sorte que mon enfant soit à l&apos;heure. Je viens le chercher dès la fin (le club n&apos;est pas une garderie !).</li>
      ...
      {/* SECTION 4 : RÈGLEMENTS, DOCUMENTS & PROTECTIONS (Temporaire en attendant les véritables documents) */}
      <section className="bg-[#000049]/5 py-16 px-6">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          
          {/* Bloc de liens de téléchargement de documents administratifs officiels */}
          <div>
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[#f368f1]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {/* Bloc Éthique & Intégrité (Réglementations gouvernementales obligatoires en contexte de sport mineur au Québec) */}
          <div className="bg-white p-6 rounded-2xl border border-[#000049]/10 flex flex-col justify-between">
            ...
            {/* Redirections officielles vers les portails gouvernementaux de protection de l'intégrité sportive */}
